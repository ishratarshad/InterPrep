...
#         "My approach is to use a hash map to store values as we iterate. "
#         "For each number, I check whether target minus the number is already "
#         "in the map. This gives us an O(n) time complexity solution."
#     )

# if "selected_lang" not in st.session_state:
#     st.session_state["selected_lang"] = "python"

# # Create fake code file for UI
# os.makedirs("code", exist_ok=True)
# with open("code/user_code.py", "w") as f:
#     f.write(
